...
control MyIngress(inout headers hdr,
    ...
    action ecmp_group(bit<14> ecmp_group_id, bit<16> num_nhops){
        ...
        // hash the 5 tuple and mod it num_nhops
        hash(meta.ecmp_hash,
          HashAlgorithm.crc16,
          (bit<1>)0,
          {
    ...
    table ecmp_group_to_nhop {
        ...
        // read the ecmp_group and send it up based on the group
        key = {
    ...
    table ipv4_lpm {
        ...
        // look at destination ip address. if it's below then send it. else run ecmp_group
        key = {
    ...
    apply {
        //TODO: implement the ingress logic: check validities, apply first table, and if needed the second table.
